...
PATH_TOP = Path(__file__).parent.parent.parent.parent
PATH_THRUST = PATH_TOP / Constants.thrust()['Path_XLSX']
...
if __name__ == '__main__':
    ...
    ax1.legend(handler1 + handler2, label1 + label2, loc='upper right', borderaxespad=-4.8)
