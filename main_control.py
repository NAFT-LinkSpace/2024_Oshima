from mypackages.for_main_processing import solve_ode_roll_control
...
class Simulator:
    def __init__(self):
        ...
        if WIND_STD_INIT == 0.0 and VARIATION_WIND_AZIMUTH != 1:
            ...
            self.wind_ang.insert(0, (0.0, float(WIND_AZIMUTH_INIT)))
    ...
    def run_single_simulation(self, wind_ang):
        wind, ang = wind_ang
        out = solve_ode_roll_control.solve_all(wind, ang)
